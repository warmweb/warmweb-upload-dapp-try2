  ...
  return (
    ...
    >
      <g>
        <path
          fill="#008cf6"
          d="M63.7,36.7c-2.6,17.5-18.8,29.6-36.3,27C9.9,61.1-2.2,44.8,0.3,27.3C2.9,9.9,19.2-2.2,36.7,0.3
		C54.1,2.9,66.2,19.2,63.7,36.7"
        />
        <path
          fill="#FEFEFE"
          d="M46.4,12.8c-6.5-4.1-11.1,4.9-11.2,5.2c-1.2,2.2-2.1,5.7-2.7,8.3L24,25l-0.3,2.3l8.3,1.2c-0.2,1.2-0.3,2-0.3,2
